  ...
  const POLICY_GOV_BAN = {
    ...
    stages: {
        ...
        options: [
          {
            id: 'A',
            label: 'A. 启动合规专项',
            detail: '立即支付合规启动费,Day 90 起每月持续合规支出。审查期内招募/购车有冷却。长期、不可撤销。',
          },
          {
            id: 'B',
            label: 'B. 聚焦扩张窗口期 ⭐ 法务建议',
            detail: '抓住扩张窗口期,合规支出暂缓。未来 30 天获得扩张 buff。',
            extraToggle: {
              id: 'loan',
              label: '同时申请扩张贷款',
              detail: '',
      ...
      verdict_ban: {
        title: '⛔ 平台监管整改通知',
        tag: '监管整改',
        desc: '经专项检查,监管部门认定贵平台存在严重合规问题(司机背调记录缺失、车辆审查体系不健全、用户数据保护不达标),依据《网络安全法》《数据安全法》及交通部相关规定作出以下处罚决定。',
        buttonLabel: '接受处罚',
      },
      resume: {
        title: '整改期解除',
